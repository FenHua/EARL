...
# change to your own checkpoint
PATH='C:/Users/FenHua/Desktop/EARL/models/c3d/checkpoints/resnext-101-kinetics-hmdb51_split1.pth'
...
def parse_opts():
    ...
    # set n_classes as 400 because of the pretrained model trained on kinetics. 
    parser.add_argument(
        '--n_classes',
        default=51,
        type=int,
