...
def generate_model(opt):
    ...
    if opt.model == 'resnet':
        ...
        from wide_resnet import get_fine_tuning_parameters
        ...
        from pre_act_resnet import get_fine_tuning_parameters
        ...
        from densenet import get_fine_tuning_parameters
    ...
    if not opt.no_cuda:
        ...
        if opt.pretrain_path:
            # print('loading pretrained model {}'.format(opt.pretrain_path))   节省时间
            pretrain = torch.load(opt.pretrain_path)
                
            model.load_state_dict(pretrain['state_dict'])
            if opt.n_finetune_classes == opt.n_classes:
